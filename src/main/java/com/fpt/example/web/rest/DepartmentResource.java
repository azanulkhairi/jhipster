...
import com.fpt.example.domain.Department;
import com.fpt.example.service.DepartmentService;
...
/**
 * REST controller for managing {@link com.fpt.example.domain.Department}.
 */
@RestController
@RequestMapping("/api")
